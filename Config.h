...
#define BUF_LEN 84
#define DAYBUF_LEN 84
#define CATCHUP_LEN 164
//#define NUM_POINTS 8 // for compass
//#define NUM_ANALOG 32 // for analogue values / 128
#define NUL_WD 10  // code for wind direction NULL value

#define ICBUF_LEN 10
#define HRREQ_LEN 6 // length of hourly i/c request message: HxxDxx (hour and date requested)
#define RT_LIMIT 100  // keeps RT index numbers to 2 digits
...
const int RainPin = 16; // pin connected to rain gauge - buckets tipped (interrupt 1);
const int WDPin = 32; // vane (wind direction)
const int VoltsPin = 26;  // under development
